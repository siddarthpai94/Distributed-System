...
A progressive lab series for implementing core replication and consensus concepts. Each exercise builds on the previous one. Recommended language: **Python or Go** (networking primitives are clean in both).
...
*Exercises designed to practice replication and consensus design and implementation.*
